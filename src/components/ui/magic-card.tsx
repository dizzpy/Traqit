...
export function MagicCard(props: MagicCardProps) {
  ...
  return (
    <motion.div
      ...
      style={{
        background: useMotionTemplate`
          linear-gradient(${innerBg} 0 0) padding-box,
    ...
    >
      <div className="absolute inset-px z-20 rounded-[inherit]" style={{ background: innerBg }} />
      ...
      <div className={cn("relative z-40", innerClassName)}>{children}</div>
    </motion.div>
  )
}
